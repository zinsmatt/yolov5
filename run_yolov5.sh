...
# python detect.py --source dataset_ismar_reloc_museum_all_frames.json --weights runs/train/exp56/weights/last.pt --name test_time  --output to_delete.json --nosave
